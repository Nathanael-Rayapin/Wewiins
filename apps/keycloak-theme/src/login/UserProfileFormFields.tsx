...
import phoneNumberIcon from "../../assets/icons/phone.svg";
...
export default function UserProfileFormFields(props: UserProfileFormFieldsProps<KcContext, I18n>) {
    ...
    return (
        <>
            <div className="firstname-and-lastname flex flex-row justify-between">
                {formFieldStates.map(({ attribute, displayableErrors, valueOrValues }) => {
                    if (attribute.name !== "firstName" && attribute.name !== "lastName") return null;
            ...
            <div className="all-other-fields flex flex-col">
                {formFieldStates.map(({ attribute, displayableErrors, valueOrValues }) => {
                    if (attribute.name === "firstName" || attribute.name === "lastName") return null;

                    // Use to display Icons
                    const hasIcon = attribute.name === "email" || attribute.name === "phoneNumber";
                    let imgSrc = emailIcon;
                                ...
                                <div className={kcClsx("kcInputWrapperClass")}>
                                    ...
                                    <div className="icon-wrapper">
                                        <InputFieldByType
                                            ...
                                            i18n={i18n}
                                        />
                                        {hasIcon && <img src={imgSrc} alt="Icon" />}
                                    </div>
