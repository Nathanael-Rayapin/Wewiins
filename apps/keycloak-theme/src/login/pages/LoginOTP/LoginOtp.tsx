...
import "../LoginVerifyEmail/LoginVerifyEmail.css";
...
export default function LoginOtp(props: PageProps<Extract<KcContext, { pageId: "login-otp.ftl" }>, I18n>) {
    ...
    const { url, user, messagesPerField, otpInputDefaultValue } = kcContext;

    const { msg } = i18n;

    const [isSubmitting, setIsSubmitting] = useState(false);

    const initialRemainingTime = kcContext.otpRemainingTime ?? 300;
                        ...
                        <form
                            ...
                            <div id="kc-form-buttons" className={kcClsx("kcFormButtonsClass")}>
                                <button
                                    name="login"
                                    id="kc-login"
                                    disabled={isSubmitting || remainingTime <= 0 || otp.length !== 6}
